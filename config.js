...
module.exports = {
    ...
    // Unterstützt mehrere Entwicklernummern durch Kommatrennung in Heroku Config Vars (z. B. 923427582273,923001112233)
    DEV: process.env.DEV ? process.env.DEV.split(',').map(num => num.trim()) : ["923427582273"],                     // Developer's contact number
